      ...
      <div class="container">
        ...
        <div id="welcome">
          <h1>
            ...
            Welcome census-mobile-frontend 👋
          </h1>
        </div>
        <!--  HERO  -->
        ...
        <div id="commands" class="rounded shadow">
          ...
          <details>
            ...
            <pre><span># Build</span>
nx build census-mobile-frontend
<span># Test</span>
nx test census-mobile-frontend
<span># Lint</span>
nx lint census-mobile-frontend
<span># Run them together!</span>
nx run-many -p census-mobile-frontend -t build test lint</pre>
          </details>
          <details>
            <summary>
              <svg
            ...
            <pre>nx show project census-mobile-frontend</pre>
          </details>
