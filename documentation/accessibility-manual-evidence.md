...
| Fixture data is served where live repository data is intended                                    | An evidence run exercises fixture content, not production-shaped content            | Closed when DSpace is running — discovery reads from the repository; fixture fallback is disclosed in the UI |
