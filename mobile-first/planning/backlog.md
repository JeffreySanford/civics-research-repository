...
- Add PR 1 readiness note with repo-verified app/API/generator facts.
...
- Confirm repository API client/base URL shape.
...
- Configure the shared repository API client/base URL.
- Add minimal home/discovery route.
- Add baseline unit test.

Acceptance:

- `apps/discovery-ui` can still serve on `4200`.
